...
//6 is same as b and shows 6n or bn band
void changeBand(){
      digit5 = LED_N_6;  
      digit4 = LED_n;     
      digit3 = 0x00; 
...
void nextband () {
    ++BANDpointer ;
    if (BANDpointer == 21) {(BANDpointer = 1);}
    get_band();
    debounceU(); 
}
...
void nextbandD() {
   --BANDpointer ;
    if (BANDpointer == 0) {(BANDpointer = 20);}
    get_band();
    debounceD(); 
}
...
void BAND6() {  
  ...
  //  digit2 = LED_N_0;
    digit1 = LED_N_6; 
    low_band_limit = 50000000;
    high_band_limit = 54000000;
    OPfreq = 50313000;
}

//4m band not for use in the USA !!!!
void BAND4() {  
    digit4 = LED_n;
    digit3 = LED_BLANK;  
    digit2 = LED_BLANK;  
  //  digit2 = LED_N_0;
    digit1 = LED_N_4; 
    low_band_limit = 70000000;
    high_band_limit = 70500000;
    OPfreq = 70100000;
}
void BAND2() {  
    digit4 = LED_n;
    ...
    digit2 = LED_BLANK;  
    digit1 = LED_N_2; 
    low_band_limit =  144000000;
    high_band_limit = 148000000;
    OPfreq = 144174000;
}
void BAND222() {  
    digit4 = LED_n;
    ...
    digit2 = LED_N_1 + 0x20;
    digit1 = LED_N_2; 
    low_band_limit =  222000000;
    high_band_limit = 225000000;
    OPfreq = 222065000;
}
void BAND70c() { 
    digit4 = LED_n;
    digit3 = LED_BLANK + 0x20;
    digit2 = LED_N_7;
    digit1 = LED_N_0; 
    low_band_limit =  420000000;
    high_band_limit = 450000000;
    OPfreq = 432174000;
}
void BANDwwv25() {  
    digit4 = LED_t;
    ...
    digit2 = LED_N_2 +0x20;
    digit1 = LED_N_5; 
    low_band_limit =  2500000;
    high_band_limit = 2500000;
    OPfreq = 2500000;
}
...
void BANDchu() {  
    ...
    digit2 = LED_N_3;
    digit1 = LED_N_3; 
    low_band_limit =  3330000;
    high_band_limit = 3330000;
    OPfreq = 3330000;
}
void BANDwwv5() {  
    digit4 = LED_t;
    ...
    digit2 = LED_BLANK;
    digit1 = LED_N_5; 
    low_band_limit =  5000000;
    high_band_limit = 5000000;
    OPfreq = 5000000;
}
...
void BANDwwv10() {  
    ...
    digit2 = LED_N_1;
    digit1 = LED_N_0; 
    low_band_limit =  10000000;
    high_band_limit = 10000000;
    OPfreq = 10000000;
}
...
void BANDwwv15() {  
    ...
    digit2 = LED_N_1;
    digit1 = LED_N_5; 
    low_band_limit =  15000000;
    high_band_limit = 15000000;
    OPfreq = 15000000;
}
